...
test_file = "/home/caoxingchao/ffz_nlp/ccir_2018/ranking/data/NYC_taxi/new_test_weekend.csv"
...
#num_test, num_feature = X_test.shape
...
#gbm = lgb.train(params, lgb_train, num_boost_round=100, feval=rmsle, valid_sets=lgb_train, feature_name=feature_name, categorical_feature=[0, 1, 2, 4, 5, 11])
...
print(timestamp)
with open('results/predict_{}.res'.format(timestamp), 'w') as f:
    for res in y_pred:
        f.write('{}'.format(res) + '\n')
print("over")
